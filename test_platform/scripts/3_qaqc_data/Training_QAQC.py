...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        prog="Training_QAQC",
        description="""This script performs qa/qc for the training station list saved on qaqc_training_station_list.csv""",
        epilog="""To run in parallel:
                  `mpirun -n <n_cores> python3 Training_QAQC.py --local True --verbose False
               """
    )
