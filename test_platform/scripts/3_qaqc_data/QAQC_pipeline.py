...
def whole_station_qaqc_training(rad_scheme, verbose=False, local=False):
    """
    """    
    # Read in network files
    # if True:
        # files_df = read_network_files_training(network, cleandir)
    #     # display(files_df)
    #     # print(stations)
    # else:
    ...
    files_df = read_network_files_training()
    # else: 
    """
    -----------------------------------
