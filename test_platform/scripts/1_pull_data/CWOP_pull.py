...
# Outputs: terrestrial and marine shapefiles, bounding box of their union.
#
...
def get_cwop_station_timeout_csv(token, bucket_name, directory):
    ...
    # files = os.listdir(bucket_name + directory) # Gets list of files in directory to work with
