...
(2) get_SCAN_stations produces a list of station IDs filtered by bounding box and network (CWOP in this case)
(3) get_SCAN_stations_meta provides metadata for SCAN stations.
...
# Function: get SCAN station list from SOAP API.
def get_SCAN_stations(terrpath, marpath):
    ...
    request_data = {
        'minLatitude': str(bbox_api[2]),
        'maxLatitude': str(bbox_api[1]),
        'minLongitude': str(bbox_api[4]),
        'maxLongitude': str(bbox_api[3]),
        'logicalAnd': 'true'
...
#                 </SOAP-ENV:Body>
#                 </SOAP-ENV:Envelope>
# """.format(bbox_api[2], bbox_api[1], bbox_api[4], bbox_api[3])
#     # headers
#     headers = {
...
get_SCAN_stations(wecc_terr, wecc_mar)
