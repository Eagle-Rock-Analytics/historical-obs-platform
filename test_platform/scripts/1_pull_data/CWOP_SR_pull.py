    ...
    for item in os.listdir(directory):
        if item.endswith(extension):
            ...
            ZipFile(zip_name).extractall(
                directory
            )  # This unzips all files to the directory. (Note you should download the files, rather than the folders from GDrive as the zip will include the file structure.)
